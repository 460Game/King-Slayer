...
//        Log.info("discover: " + address.toString());

        // For consistency, the classes to be sent over the network are
        // registered by the same method for both the client and server.
        ChatCommon.register(client);

        client.addListener(new Listener() {
            public void connected (Connection connection) {
                ChatCommon.UserName usrName = new ChatCommon.UserName("");
...
//        String host = "10.210.77.20";
        ...
        chatFrame.setSendListener(new Runnable() {
            public void run () {
                ChatCommon.ChatMsg chatMessage = new ChatCommon.ChatMsg(chatFrame.getSendText());
//                chatMessage.msg = chatFrame.getSendText();
        ...
        new Thread("Connect") {
            public void run () {
                try {
                    client.connect(5000, host, ChatCommon.port);
