...
//        Images.RED_WOOD_ARROW_TOWER_IMAGE : Images.BLUE_WOOD_ARROW_TOWER_IMAGE));
    ...
    ImageView button4image = new ImageView(Images.BARRACKS_UI_IMAGE);
    button4image.setFitWidth(32 * 1.5);
    button4image.setFitHeight(52 * 1.5);
    Button selectBarracks = new Button("", button4image); //new ImageView((model.getLocalPlayer().getTeam() == Team.ONE) ?
